...
class AFBT_Options
{
	...
	public function afbtGetOptionsScreen()
	{
		...
		// Settings form
		if (!isset($_GET['tab']) || $_GET['tab'] == 'affiliate_retrieval_section') { ?>
			<div class="container">
				<div class="">
					<h1></h1>
					<div class="col-sm-12">
						<table id="affiliate_grid" class="table table-condensed table-hover table-striped" width="60%"
							cellspacing="0" data-toggle="bootgrid">
							<div class="pull-left records-add"><button type="button" class="btn btn-xs btn-primary" id="command-add"
									data-row-id="0">
									<span
										class="glyphicon glyphicon-plus"></span><?php echo _e('Add Record', 'affiliate-booster'); ?></button>
							</div>
							<thead>
								<tr>
									<th data-column-id="w_id" data-type="numeric" data-identifier="true">
										<?php echo _e('S.No.', 'affiliate-booster'); ?>
									</th>
									<th data-column-id="website"><?php echo _e('Website Page Link', 'affiliate-booster'); ?></th>
									<th data-column-id="commands" data-formatter="commands" data-sortable="false">
										<?php echo _e('Action', 'affiliate-booster'); ?>
									</th>
								</tr>
							</thead>
						</table>
						...
						<div class="modal-body">
							<form method="post" id="frm_add">
								...
								<div class="form-group">
									<label for="page-type"
										class="control-label"><?php echo _e('Page Type', 'affiliate-booster'); ?></label><br>
									<label class="radio-inline">
										<input type="radio" name="type_page" id="page" value="page" class="radio"
											checked><?php echo _e('Page', 'affiliate-booster'); ?>
									</label>
									<label class="radio-inline">
										<input type="radio" name="type_page" id="post" value="post"
											class="radio"><?php echo _e('Post', 'affiliate-booster'); ?>
									</label>
								</div>
								<div class="form-group">
									<label for="website-page-link"
										class="control-label"><?php echo _e('Website Page Link:', 'affiliate-booster'); ?></label>
								...
								<label for="keywords"
									class="control-label"><?php echo _e('Keywords & Affiliate Link:', 'affiliate-booster'); ?></label><br>
								<div class="form-group input_fields_wrap">
									<div class="ddd">

										<input type="text" id="keywords_1" class="keywords" placeholder="Keyword: 1"
											name="keywords[]" />

										<input type="text" id="affiliate_link_1" class="affiliate_link"
											placeholder="http:// or https://" name="affiliate_link[]" />

										<button
											class="btn add_field_button btn-primary"><?php echo _e('Add More Fields', 'affiliate-booster'); ?></button>
									</div>
									<div class="input_fields_wraps"></div>
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-default close_btn "
										data-dismiss="modal"><?php echo _e('Close', 'affiliate-booster'); ?></button>
									<button type="button" id="btn_add"
										class="btn btn-primary"><?php echo _e('Save', 'affiliate-booster'); ?></button>
								</div>
							</form>
						</div>
					</div>
							...
							<form method="post" id="frm_edit">
								...
								<div class="form-group">
									<label for="page-type"
										class="control-label"><?php echo _e('Page Type', 'affiliate-booster'); ?></label><br>
									<label class="radio-inline">
										<input type="radio" name="type_page_edit" id="page_edit" value="page" class="radio_edit"
											checked><?php echo _e('Page', 'affiliate-booster'); ?>
									</label>
									<label class="radio-inline">
										<input type="radio" name="type_page_edit" id="post_edit" value="post"
											class="radio_edit"><?php echo _e('Post', 'affiliate-booster'); ?>
									</label>
								</div>
								<div class="form-group">
									<label for="website-page-link"
								...
								<div class="form-group">
									<button
										class="btn add_field_edit btn-primary"><?php echo _e('Add More Fields', 'affiliate-booster'); ?></button>
								</div>
								<label for="keywords"
									class="control-label"><?php echo _e('Keywords &amp; Affiliate Link:', 'affiliate-booster'); ?></label><br>
		...
		if (isset($_GET['tab']) && $_GET['tab'] == 'affiliate_style') {
			echo '<div class="wrap">
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" name="affiliate_boost_setting[font-size]" placeholder="10px"
							value="<?php get_option('affiliate_boost_setting')['font-size'] ?>" /></td>
				</tr>
				<tr valign="top">
					<th scope="row"><?php echo _e('Link Color', 'affiliate-booster'); ?></th>
					<td><input type="text" name="affiliate_boost_setting[font-color]"
							value="<?php get_option('affiliate_boost_setting')['font-color'] ?>" class="my-color-field" /></td>
				</tr>
			</table>
			<p><input type="submit" class="btm button-primary" name="Submit"
					value="<?php echo _e('Save Options', 'affiliate-booster'); ?>" /></p>
	...
	function afbt_replace_for_keywords($content)
	{
		...
		if ($font_color) {
			$style_color = "color:" . $font_color . ";";
		}
		if (strpos($font_size, 'px') !== false) {
			$style_color .= "font-size:" . $font_size . ";";
		} else {
			if ($font_size) {
				$style_color .= "font-size:" . $font_size . "px;";
			}
		}
